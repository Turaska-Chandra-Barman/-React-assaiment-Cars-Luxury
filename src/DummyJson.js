    ...
    Explore: [
      {
        ...
        heading: 'Subaru',
        text: 'from $40k',
        img: '/assets/vector/Subaru.svg',
      },
      {
        id: crypto.randomUUID(),
        heading: 'Mercedes-Benz',
        text: 'from $60k',
        img: '/assets/vector/Mercedes-Benz.svg',
      },
      {
        id: crypto.randomUUID(),
        heading: 'Volkswagen',
        text: 'from $15k',
        img: '/assets/vector/Volkswagen.svg',
      },
      {
        id: crypto.randomUUID(),
        heading: 'Hyundai',
        text: 'from $30k',
        img: '/assets/vector/Hyudai.svg',
      },
      {
        id: crypto.randomUUID(),
        heading: 'Toyota',
        text: 'from $27k',
        img: '/assets/vector/Toyota.svg',
      },
      {
        id: crypto.randomUUID(),
        heading: 'Infiniti',
        text: 'from $54k',
        img: '/assets/vector/infiniti.svg',
      },
    ],
  },
  {
    ...
    Reviwes: [
      {
        ...
        imgProfile: '/assets/profile-1.png',
        name: 'Hironaka Hiroe',
        profession: 'Chief Editor',
        ratingImg: '/assets/star.png',
        ratingNum: '4.91',
        result: '(98)',
      },
      {
        ...
        imgProfile: '/assets/profile-2.png',
      ...
      },
      {
        ...
        imgProfile: '/assets/profile-3.png',
        name: 'Lew Silverton',
        profession: 'Chief Editor',
        ratingImg: '/assets/star.png',
        ratingNum: '4.45',
